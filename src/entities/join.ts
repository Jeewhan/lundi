...
import {
  ACCEPT_DEPOSIT_POLICY,
  ACCEPT_LIMITED_SUPPORT,
  ACCEPT_MATCHING_UNCERTAINTY,
...
export class Join {
  ...
  public joinLunchClub(
    ...
    return this.joinClub(body, payload, "런치클럽 참가 신청", [
...

      {
        ...
        block_id: LUNCH_CLUB_TOPIC,

        element: {
          type: "checkboxes",

          action_id: LUNCH_CLUB_TOPIC,
  ...
  private joinClub(
    ...
    return {
      ...
      view: {
        ...
        blocks: [
          ...this.getNameVerificationBlocks(user.name),
          ...
          ...this.getExcludedMembersSelectionBlocks(user.groupMembers),

          {
            type: "divider",
          },

          ...this.getPolicyAgreementBlocks(),
        ],
      },
    };
  }
  ...
  private getNameVerificationBlocks(name: string) {
    return [
      {
        type: "section",
        text: {
          type: "mrkdwn",
          text: `*${name}님* 참가신청을 진행합니다.`,
        },
      },
  ...
  private getExcludedMembersSelectionBlocks(
    groupMembers?: string,
  ): KnownBlock[] {
    return [
      {
...

      {
        ...
        block_id: EXCLUDE_MEMBERS,

        element: {
          type: "multi_users_select",

          action_id: EXCLUDE_MEMBERS,

          ...(groupMembers && {
            initial_users: groupMembers.split(", "),
          }),
  ...
  private getPolicyAgreementBlocks(): KnownBlock[] {
    return [
...

      {
        ...
        block_id: ACCEPT_DEPOSIT_POLICY,

        element: {
          type: "checkboxes",

          action_id: ACCEPT_DEPOSIT_POLICY,
...

      {
        ...
        block_id: ACCEPT_MATCHING_UNCERTAINTY,

        element: {
          type: "checkboxes",

          action_id: ACCEPT_MATCHING_UNCERTAINTY,
...

      {
        ...
        block_id: ACCEPT_LIMITED_SUPPORT,

        element: {
          type: "checkboxes",

          action_id: ACCEPT_LIMITED_SUPPORT,
...

      {
        ...
        block_id: ACCEPT_PRIVACY_POLICY,

        element: {
          type: "checkboxes",

          action_id: ACCEPT_PRIVACY_POLICY,
